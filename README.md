...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mobie_utils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14538&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mobie_utils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mobie_utils` can be installed with:

```
conda install mobie_utils
```

It is possible to list all of the versions of `mobie_utils` available on your platform with:
